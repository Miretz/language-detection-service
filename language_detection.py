...
def detect_language(text):
    langdetect_results = get_langdetect_result(text)
    langid_results = get_langid_result(text)
    ...
    langs_detected = list(set(list(langdetect_results.keys()) + list(langid_results.keys())))
